...
<head>
    ...
    <title>Request for Enrollment - RegiTrack</title>
    ...
    <div class="container">
        <div class="form-container">
            <div class="form-header">
                ...
                <h2>Request for Enrollment (RF)</h2>
            </div>
            ...
            <form method="POST" action="/rf">
                ...
                <div class="form-group">
                    <label for="schl_yr">School Year</label>
                    <input type="text" id="schl_yr" name="schl_yr" placeholder="e.g., 2024-2025" required>
                </div>

...
<head>
    ...
    <title>RF Request - RegiTrack</title>
...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <div class="form-header"><i class="fa-solid fa-arrows-rotate"></i><h2>RF Request</h2></div>
            <form method="POST" action="/rf">
                ...
                <div class="form-group"><label for="schl_yr">School Year</label><input type="text" id="schl_yr" name="schl_yr" placeholder="e.g., 2024-2025" required></div>
                <div class="form-group"><label for="msg">Message</label><textarea id="msg" name="msg" rows="4" placeholder="Any additional information..."></textarea></div>

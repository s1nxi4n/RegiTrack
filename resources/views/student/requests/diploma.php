...
<head>
    ...
    <title>Diploma Request - RegiTrack</title>
...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <div class="form-header"><i class="fa-solid fa-graduation-cap"></i><h2>Diploma Request</h2></div>
            <form method="POST" action="/diploma">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="yr_grad" name="yr_grad" min="1900" max="2100" placeholder="e.g., 2024" required>
                </div>
                <div class="form-group">
